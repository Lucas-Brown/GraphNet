...
public class Arc {
     ...
     * The probability of sending the signal is determined by the probability
     * distribution
     * 
    ...
    Signal sendSignal(double signalStrength, double outputStrength) {
        // the sending node should be calling this method and should already 'know' that
        // it is transmitting the signal
        // but for sake of clarity and to make the transferrence of a signal clear, the
        // sending node is notified here
    ...
    /**
     * Attempt to send an error signal backwards from the recieving node to the
     * sending node.
     * The probability of sending the signal is determined by the probability
     * distribution
     * 
